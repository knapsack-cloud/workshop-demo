...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className="relative bg-gray-50 overflow-hidden dark:bg-gray-700 dark:text-gray-100">
      ...
      <div className="relative pt-6 pb-16 sm:pb-24">
        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            ...
            {paragraph && (
              <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl dark:text-gray-100 md:max-w-3xl">
                {paragraph}
              </p>
            )}
            {(buttonOne || buttonTwo) && (
